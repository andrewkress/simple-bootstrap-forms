...
Gem::Specification.new do |s|
  ...
  s.summary     = "Override default rails generators to use bootstrap classes on forms.  Bootstrap and other dependencies are not included."
  s.description = "Override default rails generators to use bootstrap classes on forms."
  s.license     = "MIT"
